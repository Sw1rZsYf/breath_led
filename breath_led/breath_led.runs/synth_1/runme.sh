...
HD_PWD='E:/fpga_project/Xilinx/breath_led/breath_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log breath_led_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source breath_led_top.tcl
